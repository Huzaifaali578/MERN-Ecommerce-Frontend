        ...
        <div className="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <div className="mt-6">
              ...
              {product.reviews && product.reviews.map((e, index) => (
                <div
                  key={index}
                  className="p-4 mb-4 border border-gray-300 rounded-lg shadow-sm bg-white hover:shadow-md transition-shadow"
                >
                  <p className="text-lg font-semibold text-gray-800 mb-2">
                    {e.comment}
                  </p>
                  <p className="text-sm text-gray-500 mb-1">Date: {e.date}</p>
                  ...
                  <p className="text-sm text-gray-500 mb-1">
                    Reviewer Email:{" "}
                    <span className="font-medium">{e.reviewerEmail}</span>
                  </p>
                  <p className="text-sm text-gray-500">
                    Reviewer Name:{" "}
                    <span className="font-medium">{e.reviewerName}</span>
                  </p>
                </div>
              ))}
            </div>
            <form className="mt-10"  onClick={(e)=>handleAddToCart(e)}>
              {/* Colors */}
              <div>
